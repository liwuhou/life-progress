...
The tray menu SHALL provide a settings action that opens or focuses the settings surface without creating a persistent main window.

#### Scenario: Opening settings from the tray

- **WHEN** the user selects Settings from the tray menu
- **THEN** the settings surface becomes visible
